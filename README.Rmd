...
CMAversePlus was created with specific teaching and project needs in mind. It works well for this purpose, 
...
- If `postc` is specified, labels use the randomised-analogue
  notation (e.g., `rpnde`, and totals are shown as `rte` / `rRte`).
